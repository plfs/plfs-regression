#!/bin/bash
if [ ! -x "/users/dshrader/plfs/regression_area/rrz/regression/tests/utils/rs_exprmgmtrc_target_path_append.py" ]; then
  echo "Failure: /users/dshrader/plfs/regression_area/rrz/regression/tests/utils/rs_exprmgmtrc_target_path_append.py is not executable and must be"
  exit 1
fi
source /users/dshrader/plfs/regression_area/rrz/regression/tests/utils/rs_env_init.sh
mount_points=/users/dshrader/mnt/plfs2
echo "Running /users/dshrader/plfs/regression_area/rrz/regression/tests/utils/rs_plfs_fuse_mount.sh /users/dshrader/mnt/plfs2 serial"
need_to_umount="True"
/users/dshrader/plfs/regression_area/rrz/regression/tests/utils/rs_plfs_fuse_mount.sh /users/dshrader/mnt/plfs2 serial
ret=$?
if [  "$ret" == 0 ]; then
...
plfs_tarball_path=/users/dshrader/plfs/regression_area/rrz/regression/tests/fd_consistency
...
if [ "$need_to_umount" == "True" ]; then
    echo "Running /users/dshrader/plfs/regression_area/rrz/regression/tests/utils/rs_plfs_fuse_umount.sh /users/dshrader/mnt/plfs2 serial"
    /users/dshrader/plfs/regression_area/rrz/regression/tests/utils/rs_plfs_fuse_umount.sh /users/dshrader/mnt/plfs2 serial
fi
