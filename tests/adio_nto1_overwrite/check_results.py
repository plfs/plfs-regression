...
curr_dir = os.getcwd()
basedir = re.sub('tests/adio_nto1_overwrite.*', '', curr_dir)
...
def check(output_file):
    ...
    # Mount count = number of mounts *  3 ( 3 object sizes 4M, 2M, 5M) 
    ...
    if complete_cnt != mount_count:
        ...
        ok3 = "^Data written to target file.*adio_nto1_overwrite"
